...
public class JwtService {
	...
	// write the method to extract the username from the token by dividing the token into parts and extracting the username from the payload
	...
	// write the method to generate the token by taking the userdetails as arguments and setting the claims and signing the token
		//for example
	...
	// write the method to check if the token is valid by checking the username and the expiration date
		//for example
